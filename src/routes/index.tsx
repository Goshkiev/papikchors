...
function HouseRules() {
  const rules = [
    ...
    {
      n: "03",
      t: "С уважением к Король-4",
      d: "С K-4 вылетел с турнира — заказываешь кофе соседям. С K-4 дошёл до финала — становишься фольклором.",
    },
    {
      n: "04",
...
function Hands() {
  const hands = [
    ...
    {
      quote:
        "Пришёл на первый турнир «за компанию». Остался ради кофе и атмосферы. Теперь сюда еду каждую неделю — и за столом, и за разговором после.",
      who: "Марина С.",
      role: "самопровозглашённый «вечный шорт-стэк»",
    },
    {
      quote:
        "Единственный клуб, где вылет с турнира — не конец вечера, а начало разбора раздач за кофе.",
      who: "Давит К.",
